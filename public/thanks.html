			...
			<div class="menu-mobile menu-mobile--js d-lg-none">
				...
				<div class="menu-mobile__inner">
								<ul class="menu-mobile__nav" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
									...
									<li class="menu-mobile__item" itemprop="item"><a class="menu-mobile__link" href="novosti-2016.html" itemprop="url"> <span>Новости</span></a>
									</li>
			...
			<div class="top-nav block-with-lazy d-none d-lg-block">
				<div class="container">
								<ul class="top-nav__nav" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
									...
									<li class="top-nav__item" itemprop="item"><a class="top-nav__link" href="novosti-2016.html" itemprop="url"> <span>Новости</span></a>
									</li>
						...
						<div class="col-lg">
							<div class="row">
								...
								<div class="footer__col col-md-6">
									...
									<div class="footer__text">Создание и&nbsp;продвижение  сайта: <a href="https://studiobars.ru" target="_blank"> Студия &laquo;Барс&raquo;</a> 
									</div>
								</div>
								<div class="col-md-6"><a class="develop-link" href="https://studiobars.ru" target="_blank"><span class="develop-link__panel"><img class="img-1" src="img/svg/hand.svg" alt="studiobars"/><img class="img-2" src="img/svg/logo-text.svg" alt="studiobars"/></span></a>
								</div>
							</div>
						</div>
					</div>
