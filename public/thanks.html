			...
			<div class="menu-mobile menu-mobile--js d-lg-none">
				...
				<div class="menu-mobile__inner">
								<ul class="menu-mobile__nav" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
									...
									<li class="menu-mobile__item" itemprop="item"><a class="menu-mobile__link" href="#" itemprop="url">Новости</a>
									</li>
									<li class="menu-mobile__item dropdown" itemprop="item">
										<div class="menu-mobile__link">Редукторы и мультипликаторы
											<ul class="drop">
									...
									<li class="menu-mobile__item" itemprop="item"><a class="menu-mobile__link" href="#" itemprop="url">Зубчатые передачи и&nbsp;комплектующие</a>
									</li>
									<li class="menu-mobile__item" itemprop="item"><a class="menu-mobile__link text-warning" href="#" itemprop="url">Импортозамещение</a>
									</li>
			...
			<div class="top-nav block-with-lazy d-none d-lg-block">
				<div class="container">
								<ul class="top-nav__nav" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
									...
									<li class="top-nav__item" itemprop="item"><a class="top-nav__link" href="#" itemprop="url">Новости</a>
									</li>
									<li class="top-nav__item dropdown" itemprop="item">
										<div class="top-nav__link">Редукторы и мультипликаторы
											<ul class="drop">
												<li class="drop__item"><a class="drop__link" href="#" itemprop="url">Тяжелонагруженные редукторы</a>
												</li>
												<li class="drop__item"><a class="drop__link" href="#" itemprop="url">Мультипликаторы (турборедукторы)</a>
									...
									<li class="top-nav__item" itemprop="item"><a class="top-nav__link" href="#" itemprop="url">Зубчатые передачи и&nbsp;комплектующие</a>
									</li>
									<li class="top-nav__item" itemprop="item"><a class="top-nav__link text-warning" href="#" itemprop="url">Импортозамещение</a>
									</li>
